...
//list part 2 implementing iterators



//Need begin() and end() methods to get iterators to the start and end of a list
// And matching cbegin() and cend() operators to get const iterators to the start and end of a list

// iterator begin() { return { head->next}; }   iterator end() { return tail; }
